  ...
  usersQuestions: [
    ...
    },
    {
      ...
      answer: [
        ...
        "Это лосьон, состоящий исключительно из натуральных компонентов, которые взаимодействуют только с верхнем слоем кожи «эпидермис», не проникает в глубокие слои кожи, а также питает и увлажняет.",
    ...
    },
    {
      ...
      answer: [
        ...
        "3. После банных процедур - промакивающими движениями собрать влагу с кожи (не тереть кожу полотенцем, тк загар может повредиться)",
    ...
    {
      id: 11,
      question: "Капли усилители",
      answer: [
        "Капли-усилители для загара — это насыщение оттенка загара.",
